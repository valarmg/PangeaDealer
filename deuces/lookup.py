    ...
    * 7-5-4-3-2 unsuited (worst hand possible)  => 7462
    ...
    def multiples(self):
        ...
        for i in backwards_ranks:
            ...
            kickers = list(backwards_ranks) #backwards_ranks[:]  was orig, but didn't work in python3
            kickers.remove(i)
            for k in kickers:
        ...
        for i in backwards_ranks:
            ...
            pairranks = list(backwards_ranks) #backwards_ranks[:]  was orig, but didn't work in python3
            pairranks.remove(i)
            for pr in pairranks:
